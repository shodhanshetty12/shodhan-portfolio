...
│   ├── � IEEE.pdf            # IEEE certificate
│   ├── � InternshipCertificate.pdf  # Internship certificate
│   ├── 📄 db1.pdf             # Database document 1
│   ├── 📄 db2.pdf             # Database document 2
│   ├── 📄 java.pdf            # Java document
│   └── 📄 nosql.pdf           # NoSQL document
│
...
└── 📁 images/                 # Profile and project images
    └── 👤 profile.jpeg        # Profile photo for About section
```
